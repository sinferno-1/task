...
class AddEvent extends React.Component{ 
    ...
    add = (e) => {
        ...
        this.setState({title: "", date: "", desc: "", photo: null})
                    ...
                    <form className="flex flex-col" onSubmit={this.add}>
                        ...
                        <div className="my-2 flex">
                            ...
                            <input 
                                    ...
                                    id="title" type="text" placeholder="Date" 
                                    className="w-2/3 focus:outline-none focus:shadow-outline" 
                                />
                        </div>
                        <div className="my-2 flex">
                            <label className="mx-4 text-gray-50 w-1/3 ">Description</label>
                            <textarea 
                                    value={this.state.desc}
                                    onChange={(e) => this.setState({desc: e.target.value})}
                                    id="desc" placeholder="desc" 
                                    className="w-2/3 focus:outline-none focus:shadow-outline" 
                                />
                        </div>
